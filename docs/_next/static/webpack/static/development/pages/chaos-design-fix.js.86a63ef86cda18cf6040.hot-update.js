...
/* harmony import */ var _components_Flex__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/Flex */ "./components/Flex.js");
...
function Chaos() {
  return Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])(_components_Container__WEBPACK_IMPORTED_MODULE_2__["default"], {
    pb: 5,
    __source: {
    ...
    __self: this
  }, "It turns out, he was referring to this guy, Sir John Herschel."), "![](https://mrmrs.s3.us-west-2.amazonaws.com/writing/herschel.jpg)", Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27
    },
    ...
    __self: this
  }, "23 years after their hillside chat, Darwin finally published the Origin of Species. Upon publishing, he sent a copy to Herschel with a note about Herschel's influence on his work."), "> \"...Scarcely anything in my life made so deep an impression on me: it made me wish to try to add my mite to the accumulated store of natural knowledge.\"", Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43
    },
    ...
    __self: this
  }, "Now there were two things in particular and about these tables of data that were troublesome. First off, the numbers were wrong. Secondly, it took people a lot of manual time to produce all of these inaccurate calculations. After finding yet another error, in a moment of pure frustration Herschel\u2019s friend exclaimed:"), "> \u2018I wish to God these calculations had been executed by steam' > \"I think it's possible\" replied Herschel", Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 63
    },
    ...
    __self: this
  }, "Icons, Colors, and Typography"), Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])(_components_Flex__WEBPACK_IMPORTED_MODULE_3__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 161
    },
    ...
    __self: this
  }, "Rebass: A popular react component library"), Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])(_components_Flex__WEBPACK_IMPORTED_MODULE_3__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 176
    },
    ...
    __self: this
  }, "link to the video"), " instead.")), "Demo courtesty of [@winkervsbecks](https://twitter.com/winkerVSbecks) What else can we learn together? What other types of information can we make available to each other and contribute to our collective knowledge? These aren\u2019t trade secrets. It\u2019s not a zero sum game. We share information now! But we do it at a small scale with slow feedback loops. Besides just two colors - what can we learn about how different visual properties relate to each other? This is part of why [John Otander](https://twitter.com/4lpine) started to build [Components AI](https://components.ai) What can we actually track over time about how values and combinations of properties relate to each other? For us it's a natural extension of [Random A11y](https://randoma11y.com) ![List of CSS properties](https://mrmrs.s3.us-west-2.amazonaws.com/writing/properties.jpg) The above is a long list of properties in css. But it\u2019s not that long if you are a computer. On top of that - many of these properties are not needed when styling an element. When I\u2019m styling a button, I don\u2019t expect to use volume. Or page-break. Or a number of other properties. [So what if we documented what we know so far about styling components. And created open templates for common components?](http://mrmrs.cc/writing/component-styling-api/) Where design now becomes configuring an obvious set of properties, instead of needing to guess and declare.", Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])("video", {
    controls: true,
    width: "100%",
    __source: {
      fileName: _jsxFileName,
    ...
    __self: this
  }, "link to the video"), " instead.")), "The goal is not to eliminate options, it\u2019s to narrow focus on the essential, allowing for expansion and exploration if necessary.", Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])("video", {
    controls: true,
    width: "100%",
    __source: {
      fileName: _jsxFileName,
    ...
    __self: this
  }, "link to the video"), " instead.")), "This idea of defining a component API has benefits extending beyond just these types of interfaces. Can we leverage teaching a computer what a button looks like in creative ways? Imagine having a design query language where you could ask to see all of the unique table styles in your app. Or all of the error states. Currently to do these types of audits, it takes a lot of rote work - and is likely to be outdated the week after it's finished. ![](https://mrmrs.s3.us-west-2.amazonaws.com/writing/buttons.jpg)", Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])("p", {
    fontSize: 1,
    mt: 0,
    py: 1,
    __source: {
    ...
    __self: this
  }, "Interface from sliding through scales constructed from scraped css"), "What if you controlled inputs for a generative component design tool by deciding if you wanted to use the most popular or the least used values? ## ## Continuing to look elsewhere If we take a look at what people are doing with machine learning, it\u2019s hard to [not be intrigued by reinforcement learning](https://arxiv.org/pdf/1708.05866.pdf). ***REINFORCEMENT LEARNING IS TRIAL AND ERROR AT A VAST SCALE*** ![](https://mrmrs-videos.s3.amazonaws.com/python.gif) From [How to teach AI to play Games: Deep Reinforcement Learning](https://towardsdatascience.com/how-to-teach-an-ai-to-play-games-deep-reinforcement-learning-28f9b920440a) There are people trying to train computers on how to beat video games.  And they are getting pretty good. Which is probably worth a whole talk in itself. Now training computers to beat video games seems like a pretty obvious thing the first time you see it. The first time I saw a demo of it in practice though - this is the image that flashed in my head. ![](https://mrmrs.s3.us-west-2.amazonaws.com/writing/lighthouse.jpg)", Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])("p", {
    fontSize: 1,
    mt: 0,
    py: 1,
    __source: {
    ...
    __self: this
  }), "It\u2019s from a study referenced in last years article titled [The Surprising Creativity of Digital Evolution: A Collection of Anecdotes from the Evolutionary Computation and Artificial Life Research Communities](https://arxiv.org/pdf/1803.03453.pdf) In it the constraint is that the grip has been disabled, but the crane is still able to grab ahold of the ball and move it between any two points. Will we learn to apply this type of optimization learning to interface design?", Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])("iframe", {
    width: "100%",
    height: "315",
    ...
    __self: this
  }), "My mind wonders at the creative solutions computers might come up with to get a website to be fully responsive, performant, and accessible. Project Dreamcatcher is a generative design project at Autodesk. They\u2019ve started to incorporate some of that technology into other products and the industrial design industry is already seeing real world results. This is a tool that people use overhead, so weight is a primary concern. But they also have a constraint that it can\u2019t be any weaker. With this problem and constraint, they were able to use generative design to shave off 3 pounds. That\u2019s a 60% reduction in weight. ![](https://mrmrs.s3.us-west-2.amazonaws.com/writing/tool.jpg)", Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])("p", {
    fontSize: 1,
    mt: 0,
    py: 1,
    __source: {
    ...
    __self: this
  }, "There are 128 combinations of color based theming options from curated values"), Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])(_components_Flex__WEBPACK_IMPORTED_MODULE_3__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 615
    },
    __self: this
  }, "![Mac Os Screenshot](https://mrmrs.s3.us-west-2.amazonaws.com/writing/mac2.jpg) ![Mac Os](https://mrmrs.s3.us-west-2.amazonaws.com/writing/mac3.jpg) ![Mac Os](https://mrmrs.s3.us-west-2.amazonaws.com/writing/mac4.jpg)"), "My best guess is it [we will see augmented reality usage grow](https://www.osapublishing.org/DirectPDFAccess/FF7D6769-D38A-8C65-35F3CB19F8D4BBF6_398845/optica-5-10-1200.pdf?da=1&id=398845&seq=0&mobile=no) the most in the immediate future. As AR and VR become more prevalent, will interface design largely be world building? ; Will we interact with computers and machines by moving our body in expressive ways to manipulate our  virtual environment? ![Breath of the Wild](https://mrmrs.s3.us-west-2.amazonaws.com/writing/botw.jpg)", Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])("p", {
    fontSize: 1,
    mt: 0,
    py: 1,
    __source: {
    ...
    __self: this
  }, "Breath of the Wild"), "Regardless of what the future brings, our problem space is growing every single day. And we need better feedback loops to handle the increasing amount of chaos. I\u2019m pretty sure robots won't be taking away our jobs. But I do think they will take away some of our current work. I\u2019m excited about that future though. I imagine we will spend more and more time [defining a desired output with what our constraints are](https://github.com/papers-we-love/papers-we-love/raw/master/design/out-of-the-tar-pit.pdf).", Object(_jsx__WEBPACK_IMPORTED_MODULE_1__["default"])("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 635
    },
...
//# sourceMappingURL=chaos-design-fix.js.86a63ef86cda18cf6040.hot-update.js.map