...
module.exports = __webpack_require__("cMSM");
...
function MDXContent(_ref) {
  ...
  return Object(_mdx_js_react__WEBPACK_IMPORTED_MODULE_3__["mdx"])(MDXLayout, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, layoutProps, props, {
    ...
    mdxType: "PostHeader"
  }), Object(_mdx_js_react__WEBPACK_IMPORTED_MODULE_3__["mdx"])("p", null, "HTML is by default: responsive, vector, and highly readable on any device."), Object(_mdx_js_react__WEBPACK_IMPORTED_MODULE_3__["mdx"])("p", null, "If you find yourself writing Css that removes any of these three\nfeatures, take a minute to stop and rethink its purpose.  Ask yourself what\nproblem could be so important that it's worth solving at the cost of\nuniversal access to your content ", "&", " readability?"), Object(_mdx_js_react__WEBPACK_IMPORTED_MODULE_3__["mdx"])("p", null, "Css is not here to make our lives as developers easy. It's here to enhance\nthe usability of the web for our users. ", Object(_mdx_js_react__WEBPACK_IMPORTED_MODULE_3__["mdx"])("em", {
    parentName: "p"
  }, "Css should never"), " limit usability."), Object(_mdx_js_react__WEBPACK_IMPORTED_MODULE_3__["mdx"])("p", null, "When we write stylesheets that cascade, we should keep these simple points in\nmind.")));
}
